var portalsForWorld = (()=>{
    ...
    xyzmove4mat( portalsForWorld[4][1].matrix, [0,0,0.2]);  //move portal from world 4 to world 5
    xyzmove4mat( portalsForWorld[5][0].matrix, [0.4,0,0.4]);    //move portal from world 5 to world 4   (otherwise inside object)
    ...
    xyzmove4mat( portalsForWorld[7][0].matrix, [0,0,-0.2]);   //move portal from world 7 to world 8
