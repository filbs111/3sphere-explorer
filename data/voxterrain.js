...
var voxTerrainData = (function generateMultiVoxTerrainData(){
	...
	function generateVoxTerrainData(voxFunction){
		...
		//doesn't work. not sure why... ?!!!!1
		//var surfaceParticleMats = generateSurfaceParticleMats();
	...
	// function generateSurfaceParticleMats(){
	// 	var mats=[];
	// 	var nummats = 8192;
	// 	for (nn=0;nn<nummats;nn++){
	// 		var this4vec = random_quaternion();
	...
	// 		for (var step=0;step<10;step++){	//only 1 step leads to nice accidental randomness effect
	// 			estSurfPoint = closestPoint(this4vec,0);
	// 			console.log("www - " + JSON.stringify(estSurfPoint));
	// 			console.log(estSurfPoint);
	// 			//var thisABC = estSurfPoint['abc'];	//estSurfPoint.abc;
	// 			var thisABC = estSurfPoint.abc;
	// 			console.log("xxx - " + thisABC);
	// 			this4vec = get4vecForABCDCCoords(thisABC.a,thisABC.b,thisABC.c)
	// 			console.log("yyy")
	// 		}
