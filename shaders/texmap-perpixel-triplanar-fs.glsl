...
out vec4 fragColor;
	...
	light+=phongAmount;
		...
		vec4 preGammaFragColor = vec4( fog*( uPlayerLightColor.xyz*light + uReflectorDiffColor*portalLight + uReflectorDiffColor2*portalLight2 + uFogColor.xyz ), 1.0)*adjustedColor*vec4(texColor,1.) + (1.0-fog)*uFogColor;
